			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="product-content">
						...
						<h6>Category Name: <strong>{{ $single_product_info->relationtocategory->category_name }}</strong></h6>
						<br>
						<div class="pc-meta">
				...
				@forelse ($related_products as $related_product)
					<div class="col-lg-3">
						...
						<div class="alert alert-danger m-auto">
							No related products in this category to show
						</div>
				@endforelse
			</div>
		</div>
